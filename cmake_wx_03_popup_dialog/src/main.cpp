...
{
#if 0
	CKroemFrame* frame01 = new CKroemFrame(NULL, wxID_ANY, "First App"); 
	frame01->Show();
#elif 1

    CKroemFrame* frame01 = new CKroemFrame(wxPoint(0, 0), 1, 1);
	frame01->Show();

    wxPosFrame* frame02 = new wxPosFrame;
	frame02->Create(NULL,wxID_ANY,"First App",wxPoint(500, 500),wxSize(600,400), wxSTAY_ON_TOP,wxPanelNameStr); 
	frame02->Enable(true);
	frame02->Show();
#endif
